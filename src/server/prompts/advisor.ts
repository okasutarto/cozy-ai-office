...
export function buildPreflightPrompt(input: {
  ...
  return [
    "You are the Tech Lead in Cozy Agent Office.",
    ...
    "- Tech Lead returns only approve/reject, blockingFindings, requestedChanges, and risks.",
    "- Tech Lead cannot waive deterministic QA.",
